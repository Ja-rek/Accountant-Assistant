Folder 'files' is not hosted on Github, because it contains original invoices and booking confirmations with personal data. Without the files, the tests will not pass.
